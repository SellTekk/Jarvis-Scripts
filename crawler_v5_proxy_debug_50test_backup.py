...
def create_driver_fresh():
    """Erstellt neuen Browser (Fuer Neustart) - SICHTBAR"""
    log("[*] Erstelle neuen Browser (sichtbar)...")
    options = Options()
    
    # Browser immer sichtbar - KEIN headless!
    ...
    # NICHT fuer Windows: --no-sandbox und --disable-dev-shm-usage
    
    log("[*] Chrome-Optionen: sichtbar, NICHT headless")
