"""
Verkaufen.de Preis-Crawler v7.2 - Mit Proxy Auth Extension
"""
...
def create_driver():
    ...
    ext_path = os.path.abspath("C:/Users/no/.openclaw/workspace-verkaufen-decrawler/proxy_auth")
...
def main():
    print("=== VK Preis-Crawler v7.2 - Proxy Auth ===")
    ...
    try:
        ...
        if all_results:
            ...
            print(f"\nFertig! {len(all_results)} Ergebnisse")
