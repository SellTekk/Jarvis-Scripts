...
description: "Closed-loop Bridge: OpenClaw -> GitHub -> Codex -> PR -> merge to main -> git pull -> OpenClaw. Trigger this when user says 'mach codex stuff', 'delegiere an codex', 'erstelle code', or 'dispatch codex task'."
---
